...
VALUES
  (
    1,
    'receita',
    '[\"farinha 150g\",\" 3 ovos\",\" 1\\/4 de chicara oleo\",\" sal a gosto\"]',
    'joga tudo e mexe bem ate ficar uniforme',
    150.00,
    50.00,
    79.00,
    2.00,
...
VALUES
  (
    ...
    62.00,
    180.00,
    'gabrielscremim@edu.unifil.br',
    '$2y$10$q.I2xKPt/mr74rMb1X11Xu/ojFT4eugRDvusQMyZQxIWUO5djISla',
    'Scremim'
  );
...
ADD
  KEY `dietas_ibfk_1` (`fk_id_usuario_dieta`);
...
ADD
  PRIMARY KEY (`id`),
ADD
  KEY `fk_id_evolucaos` (`fk_id_evolucaos`);
...
ADD
  KEY `fk_id_user_receita` (`fk_id_user_receita`);
...
ADD
  PRIMARY KEY (`id`),
ADD
  KEY `fk_id_usuario_treino` (`fk_id_usuario_treino`);
...
ALTER TABLE
  `dietas`
MODIFY
  `id_dieta` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 11;
...
ALTER TABLE
  `receita`
MODIFY
  `id_receitas` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 4;
...
ALTER TABLE
  `dietas`
ADD
  CONSTRAINT `dietas_ibfk_1` FOREIGN KEY (`fk_id_usuario_dieta`) REFERENCES `users` (`id`);
...
ALTER TABLE
  `evolucaos`
ADD
  CONSTRAINT `fk_id_evolucaos` FOREIGN KEY (`fk_id_evolucaos`) REFERENCES `users` (`id`);
...
ALTER TABLE
  `receita`
ADD
  CONSTRAINT `fk_id_user_receita` FOREIGN KEY (`fk_id_user_receita`) REFERENCES `users` (`id`);
...
ALTER TABLE
  `treino`
ADD
  CONSTRAINT `treino_ibfk_1` FOREIGN KEY (`fk_id_usuario_treino`) REFERENCES `users` (`id`);
